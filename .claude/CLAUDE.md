...
- Skills are authored under `skills/` at the repo root, but Claude Code only loads them from `.claude/skills/`. Install by copying (`./install.sh <project>` does this for any project, including this one); commit both copies.
